...
const List<LevelData> allLevels = [
  ...
  // ─── LEVEL 4: Deepfakes & Voice Cloning ──────
  LevelData(
    level: 4,
    emoji: '🎭',
    title: 'Deepfakes & Voice Cloning',
    subtitle: 'When seeing isn\'t believing',
    description: 'Learn how AI is used to create fake videos and voices to scam people.',
    animationKey: AnimationTopic.deepfake, // ← deepfake animation
    lessonPages: [
      LessonPage(
        emoji: '🤖',
