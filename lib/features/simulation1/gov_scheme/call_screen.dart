...
class _CallScreenState extends State<CallScreen>
  ...
  void initState() {
    ...
    // Speak incoming call screen after build
  ...
  void _speakIncoming() {
    ...
    tts.speak(
      "Incoming call from Gov Scheme Officer. "
      "Unknown number — be careful. "
  ...
  void _speakConversation() {
    ...
    if (!tts.enabled) return;
    tts.speak(
      "Call connected. The scammer is saying: "
      "Namaste ji. I am calling from PM Kisan office. "
      "Your 6000 rupee payment is ready. "
      "Share your OTP right now, otherwise payment will be cancelled. "
      "Government NEVER asks for OTP on a call. This is a scam. "
      "What will you do? Tap Share OTP or Hang Up — Never Share OTP."
    );
  }
              ...
              children: [
                ...
                ScaleTransition(
                  ...
                  child: Container(
                    ...
                    child: const Icon(Icons.account_circle, size: 66, color: Color(0xFF388BFD)),
                  ),
                ),
                const SizedBox(height: 18),
                const Text(
                ...
                const SizedBox(height: 6),
                const Text("+91 98765 43210", style: TextStyle(color: Color(0xFF8B949E), fontSize: 15)),
                const SizedBox(height: 14),
                Container(
                  margin: const EdgeInsets.symmetric(horizontal: 32),
                ...
                const Spacer(),
                const Text("Slide to answer or decline", style: TextStyle(color: Color(0xFF8B949E), fontSize: 13)),
                const SizedBox(height: 20),
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 40),
                  child: Row(
                    ...
                    children: [
                      ...
                      _callButton(
                        ...
                        onTap: () {
                          ...
                          _pulseController.stop();
                          _startCallTimer();
                          WidgetsBinding.instance.addPostFrameCallback((_) => _speakConversation());
                        },
                      ),
                    ],
                  ),
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 10),
          Text(label, style: const TextStyle(color: Colors.white70, fontSize: 14, letterSpacing: 0.3)),
        ],
      ),
    );
  }
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text("Call Connected  $_callDuration",
                ...
                Container(
                  ...
                  child: const Icon(Icons.account_circle, size: 60, color: Colors.white54),
                ),
                const SizedBox(height: 10),
                const Text("Gov Scheme Officer",
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          const Icon(Icons.record_voice_over, color: Color(0xFF388BFD), size: 18),
                          const SizedBox(width: 8),
                          Text("Scammer is saying...",
                              style: TextStyle(color: Colors.blue.shade300, fontSize: 13, fontWeight: FontWeight.w600)),
                        ],
                      ),
                      const SizedBox(height: 10),
                      const Text(
                  ...
                  child: const Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          "Government NEVER asks for OTP on a call. This is a scam.",
                          style: TextStyle(color: Colors.red, fontSize: 13, fontWeight: FontWeight.w500, height: 1.5),
                        ),
                      ),
                    ],
                  ),
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () => _showResult(false),
                          icon: const Icon(Icons.share, size: 22),
                          label: const Text("Share OTP", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.red.shade700,
                            foregroundColor: Colors.white,
        ...
        title: Row(
          children: [
            Icon(safe ? Icons.shield : Icons.warning_amber_rounded,
                color: safe ? Colors.green : Colors.red, size: 32),
            const SizedBox(width: 10),
            Text(safe ? "Well Done! ✅" : "Oops! ❌", style: const TextStyle(fontSize: 22)),
          ],
        ),
        content: Text(
          safe
