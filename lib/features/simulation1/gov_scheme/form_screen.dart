...
class _FormScreenState extends State<FormScreen> {
  ...
  static const _screenTexts = [
    ...
    "Scam Alert. No government officer will call you after this form asking for OTP or money. If someone calls, it is a scam.",
    "Part A. Select the scheme you want to apply for.",
    "Part B. Enter your personal details — full name, father or husband name, and mobile number.",
    "Part C. Enter your Aadhaar number. Only enter Aadhaar on official dot gov dot in websites.",
    "Part D. Enter your bank account number and IFSC code for direct benefit transfer.",
    "Part E. Enter your village and state.",
    "Read the declaration carefully and tick the checkbox to accept.",
    "Then tap Submit Application button.",
  ];
  ...
  void _submitForm() {
    ...
    _speakDialog(
      "Confirm Submission. "
      "You are about to submit your application. "
      "Important: Real government websites never ask for OTP over phone, "
      "payment to process application, or password of any account. "
      "This is a simulation to help you learn. "
      "Tap Submit Application to continue or Cancel to go back."
    );
          ...
          child: Column(
            ...
            children: [
              ...
              _buildField(
                ...
                inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                maxLength: 12,
                warningMessage: "Real Aadhaar should only be entered on official government websites ending in dot gov dot in. Example: pmkisan dot gov dot in. Never share Aadhaar on unknown sites or WhatsApp.",
                validator: (v) => v == null || v.length != 12 ? "Aadhaar must be 12 digits" : null,
              ),
              ...
              _buildField(
                ...
                keyboardType: TextInputType.number,
                inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                warningMessage: "Bank account number is used to send money directly to you. Safe to enter here. But never share your ATM PIN, internet banking password, or OTP.",
                validator: (v) => v == null || v.trim().length < 9 ? "Enter valid account number" : null,
              ),
